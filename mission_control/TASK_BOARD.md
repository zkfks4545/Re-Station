...
| PIPE-806 FSM 점진 적용 | DOING | A `f691adf`: ControlIntent. B `507abfc`: topic·speech·entity. B.1 `ea3527c`: active session. B.2 `a02abe8`: 카루아 취향 질문·조사 보정 완료. 다음 C PreferenceEvidence → D Conversation Expansion | B.2: 67 files / 902 tests, check, lint, build, 24개 질문 fixture·전용 ResponsePlan·조사 결합 | A/B/B.1/B.2 완료. 전체 완료 조건은 단일 intent 의존 제거, 각 소비 단계 독립 검증, P0.5 계약 유지 |
