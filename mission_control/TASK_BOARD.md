...
| PIPE-806 FSM 점진 적용 | DOING | A `f691adf`: safety·추천 취소 ControlIntent 완료. B `507abfc`: topic·speech·entity 완료. 다음 C PreferenceEvidence → D Conversation Expansion | B: 65 files / 864 tests, check, lint, build, topic·speech·entity Replay와 불일치 fallback | A/B 완료. 전체 완료 조건은 단일 intent 의존 제거, 각 소비 단계 독립 검증, P0.5 계약 유지 |
