...
| PIPE-806 FSM 점진 적용 | DOING | A `f691adf`: ControlIntent. B `507abfc`: topic·speech·entity. B.1 `ea3527c`: active session. B.2 `a02abe8`: 카루아 취향. C `19d032c`: PreferenceEvidence 호환 소비 완료. 다음 D Conversation Expansion | C: 67 files / 906 tests, check, lint, build, legacy 누적 projection Replay·scope·fallback | A/B/B.1/B.2/C 완료. 전체 완료 조건은 단일 intent 의존 제거, 각 소비 단계 독립 검증, P0.5 계약 유지 |
