...
| Phase 10 | ResponsePlan DB 리팩토링 | 진행 중 | 완성 대사 DB를 의미·표현 블록 중심 ResponsePlan DB로 전환 | 대화 14개 카테고리·108개 문장 + Recommendation Formatter 3/4(randomPick, exact, nearest fallback). formatter plan 17개·template line 99개, 필수 expression·제한 slot·legacy formatter fallback 고정 |
