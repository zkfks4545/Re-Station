...
- [x] **DATA-804 칵테일별 이야깃거리 추가**: 45개 칵테일 전체에 `talking_points`를 2개씩 추가했다. 역사나 창작자를 단정하는 필드가 아니라, 레시피·맛·질감·세션 맥락에서 카루아가 꺼낼 수 있는 비권위 대화 소재로 관리한다.
...
11. WebLLM RST-601~606 재개 여부 논의
