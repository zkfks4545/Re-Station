...
export const RAW_RESPONSE_PLANS: readonly ResponsePlan[] = [
  ...
  },
  {
    ...
    blocks: {
      answer: [
        line('여긴 실제 매장 안내보다는 가상의 바 대화와 칵테일 추천을 위한 공간이에요. 메뉴나 취향 쪽은 바로 도와드릴게요.', 'talk'),
        line('실제 예약이나 결제 안내는 제공하지 않아요. 대신 지금 고르고 싶은 잔은 같이 찾아볼 수 있어요.', 'talk'),
        line('여기서는 칵테일 이야기 위주로 도와드리고 있어요. 다른 게 필요하시면 말씀해 주세요.', 'talk'),
        line('이 공간은 실제 매장 연동보다는 칵테일 추천과 대화 중심으로 운영되고 있어요.', 'talk'),
        line('안타깝게도 실제 매장 정보는 제공하지 않아요. 대신 칵테일 추천으로 도와드릴게요.', 'talk'),
        line('안타깝게도 실제 매장 정보는 제 영역을 벗어나는 질문이에요. 칵테일 쪽으로 도와드려도 될까요?', 'talk'),
        line('이 공간은 가상의 바라서 실제 예약이나 위치 안내는 어려워요. 대신 취향에 맞는 칵테일을 찾는 데 집중해 보시죠.', 'talk'),
        line('실제 매장 문의는 제가 도와드리기 어려운 부분이에요. 그래도 칵테일에 관한 질문이라면 얼마든지 편하게 물어봐 주세요.', 'talk'),
      ],
    },
    fallbackText: '여긴 실제 매장 안내보다는 가상의 바 대화와 칵테일 추천을 위한 공간이에요. 메뉴나 취향 쪽은 바로 도와드릴게요.',
  },
  {
  ...
  },
  {
    ...
    blocks: {
      answer: [
        ...
        line('그건 제가 해드릴 수 없는 요청이에요. 다른 걸로 도와드릴까요?', 'stern'),
  ...
  },
  {
    ...
    blocks: {
      answer: [
        ...
        line('추천을 도와드릴게요. 좀 더 구체적으로 말씀해 주실수록 정확한 추천이 가능해요.', 'talk'),
  ...
  },
  {
    ...
    blocks: {
      answer: [
        ...
        line('달콤한 것을 원하시는 마음, 충분히 이해해요. 몇 가지 좋은 추천이 있어요.', 'talk'),
      ],
    },
